...
import { useCallback, useEffect, useMemo, useState, lazy, Suspense, type ComponentType } from "react";
...
const LazyTypeaheadMenuPlugin = lazy(async () => {
	const mod = await import("@lexical/react/LexicalTypeaheadMenuPlugin");
	return { default: (mod as any).LexicalTypeaheadMenuPlugin };
...
export function MentionsPlugin(): JSX.Element | null {
	...
	return (
		<Suspense fallback={null}>
			<LazyTypeaheadMenuPlugin
				onQueryChange={setQueryString}
				onSelectOption={onSelectOption}
				triggerFn={checkForMentionMatch}
				options={options}
				menuRenderFn={(anchorElementRef: any, { selectedIndex, selectOptionAndCleanUp, setHighlightedIndex }: any) => {
