 ...
 *         description: Unauthorized
 */
router.get("/", authMiddleware_1.requireAuth, postController_1.getPosts);
router.get("/:id", authMiddleware_1.requireAuth, postController_1.getPost);
router.post("/", authMiddleware_1.requireAuth, postController_1.createPost);
router.put("/:id", authMiddleware_1.requireAuth, postController_1.updatePost);
router.delete("/:id", authMiddleware_1.requireAuth, postController_1.deletePost);
